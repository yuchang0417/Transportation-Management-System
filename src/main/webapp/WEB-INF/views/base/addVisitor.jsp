  ...
  <body>
    ...
    <div class="jumbotron">
      ...
      <div class="span-12 last">	
		<form:form modelAttribute="product" action="submitVisitor" method="post" enctype="multipart/form-data">
		  	<fieldset>		
				<legend>product Fields</legend>
				<p>
					<form:label	for="VisitorId" path="VisitorId" cssErrorClass="error">Id:</form:label><br/>
					<form:input path="VisitorId" /> <form:errors path="VisitorId" />			
				</p>
				<p>
				...
				<p>	
					<form:label for="<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1"%>
...
<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
      <div class="span-12 last">	
		<form:form modelAttribute="product" action="submitmanager" method="post" enctype="multipart/form-data">
		  	<fieldset>		
				<legend>product Fields</legend>
				<p>
					<form:label	for="VisitorId" path="VisitorId" cssErrorClass="error">Id:</form:label><br/>
...
<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
      <div class="span-12 last">	
		<form:form modelAttribute="product" action="submitmavisitor" method="post" enctype="multipart/form-data">
		  	<fieldset>		
				<legend>product Fields</legend>
				<p>
					<form:label	for="VisitorId" path="VisitorId" cssErrorClass="error">Id:</form:label><br/>
				...
				<p>
					<form:label	for="VisitorEmail" path="VisitorEmail" cssErrorClass="error">VisitorEmial:</form:label><br/>
...
</body></html>" path="name" cssErrorClass="error">name:</form:label><br/>
