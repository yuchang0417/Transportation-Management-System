...
<script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
  ...
  <body>
    ...
    <div class="jumbotron">
      <div class="container">
        <h1>You have sucessfuly logout</h1>
        <p>Your can cLick the Button Below to our home page </p>
        <p><a class="btn btn-primary btn-lg" href="getIn" role="button">Home Page»</a></p>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          ...
          <p><a class="btn btn-default" href="getIn" role="button"> »</a></p>
       </div>
