...
<li><a href="delete?id=${Account.userId}">Delete</a></li>



<li><a href="showStudent?id=${Account.userId}">${Account.userFirstName}  ${Account.userLastName }  </a></li>
<li>  Contact Email   ${Account.userEmail}  	     </li>
<li>  Contact Phone ${Account.userPhone}  	     </li>
<li> UserZip: ${Account.userzip} </li>
<li> UserAddress:${Account.userStreet} </li>
 </ul>
